...
class TestOptimizeParamsModel():
    ...
    def test_createHyperParamsListRandom(self):
        ...
        rangeForHyperParamsObj.dropOutDict = {'min': 0, 'max': 0}
        ...
        rangeForHyperParamsObj.learningRateDecayDict = {'min': 1e-7, 'max': 1e-7}
        rangeForHyperParamsObj.learningRateDict = {'min': 1e-5, 'max': 1e-5}
        rangeForHyperParamsObj.learningRateLogBool = True
        rangeForHyperParamsObj.nbrOfHiddenLayersDict = {'min': 100, 'max': 100}
        rangeForHyperParamsObj.nbrOfHiddenUnitsDict = {'min': 100, 'max': 100}
